...
class Inventory extends Model
{
    ...
    // Relationships
    public function accountablePersonnelRelation()
    {
    ...
    public function operatingUnitRelation()
    {
    ...
    {
        return $this->belongsTo(Make::class, 'make_id', 'id'); // Fixed typo
    }
    ...
    public static function validationRules($id = null)
    {
        return [
            ...
            'province_id' => 'required|exists:provinces,id', // Fixed table name
