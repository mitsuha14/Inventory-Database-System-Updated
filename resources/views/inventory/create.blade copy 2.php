                ...
                <div class="flex-auto p-4">
                    ...
                    <form wire:submit.prevent="save">
                        <div class="flex flex-wrap -mx-3">
                            ...
                            <div class="max-w-full px-3 w-1/2 lg:flex-none">
                                <div class="flex flex-col h-full">
                                    <h6 class="font-bold leading-tight uppercase text-size-xs text-slate-500">Accountable Personnel</h6>
                                    <div class="mb-4">
                                        <input wire:model.blur="inventory.accountable_personnel_id" type="text"
                                            ...
                                            placeholder="Accountable Personnel ID" id="accountable-personnel-id" required />
                                        @error('inventory.accountable_personnel_id')
                                            <p class="text-size-sm text-red-500">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    <h6 class="font-bold leading-tight uppercase text-size-xs text-slate-500">Division</h6>
                                    <div class="mb-4">
                            ...
                            <div class="max-w-full px-3 w-1/2 lg:flex-none">
                                <div class="flex flex-col h-full">
                                    <h6 class="font-bold leading-tight uppercase text-size-xs text-slate-500">Province</h6>
                                    <div class="mb-4">
                                    ...
                                    <h6 class="font-bold leading-tight uppercase text-size-xs text-slate-500">Operating Unit</h6>
                                    <div class="mb-4">
                        ...
                        <div class="flex flex-wrap -mx-3">
                            ...
                            <div class="max-w-full px-3 w-1/2 lg:flex-none">
                                <div class="flex flex-col h-full">
                                    ...
                                    <h6 class="font-bold leading-tight uppercase text-size-xs text-slate-500">Serial Number</h6>
                                    <div class="mb-4">
                            ...
                            <div class="max-w-full px-3 w-1/2 lg:flex-none">
                                <div class="flex flex-col h-full">
                                    ...
                                    <h6 class="font-bold leading-tight uppercase text-size-xs text-slate-500">Property Number</h6>
                                    <div class="mb-4">
                        ...
                        <div class="flex flex-wrap -mx-3">
                            ...
                            <div class="max-w-full px-3 w-1/2 lg:flex-none">
                                <div class="flex flex-col h-full">
                                    <h6 class="font-bold leading-tight uppercase text-size-xs text-slate-500">Acquisition Date</h6>
                                    <div class="mb-4">
                                    ...
                                    <h6 class="font-bold leading-tight uppercase text-size-xs text-slate-500">Balance Per Card</h6>
                                    <div class="mb-4">
                                    ...
                                    <h6 class="font-bold leading-tight uppercase text-size-xs text-slate-500">Source</h6>
                                    <div class="mb-4">
                            ...
                            <div class="max-w-full px-3 w-1/2 lg:flex-none">
                                <div class="flex flex-col h-full">
                                    <h6 class="font-bold leading-tight uppercase text-size-xs text-slate-500">Unit Value</h6>
                                    <div class="mb-4">
                                    ...
                                    <div class="mb-4">
                                        <input wire:model.blur="inventory.status" type="text"
                                            class="text-size-sm focus:shadow-soft-primary-outline leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 px-3 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:bg-white focus:text-gray-700 focus:outline-none focus:transition-shadow"
