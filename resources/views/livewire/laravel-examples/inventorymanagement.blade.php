                        ...
                        <tr>
                            ...
                            <td class="p-2 text-center align-middle border-b whitespace-nowrap">
                                <div class="flex justify-center space-x-2">
                                    ...
                                    <form>
                                        @csrf
                                        <button type="submit" class="text-blue-600 hover:text-blue-900" title="Edit">
                                            <i class="fas fa-edit"></i>
                                        </button>
                                    </form>
                                    
                                    <form action="{{ route('inventory.delete', $inventory->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this inventory {{$inventory->id}} ')">
                                        @csrf
                                        @method('DELETE')
